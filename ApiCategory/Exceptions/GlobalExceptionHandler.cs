using BadRequestException = ApiCategory.Exceptions.BadRequestException;
using KeynotFoundException = ApiCategory.Exceptions.KeyNotFoundException;
using NotFoundException = ApiCategory.Exceptions.NotFoundException;
using UnauthorizedException = ApiCategory.Exceptions.UnauthorizedException;
using System.Net;
