using BadRequestException = ApiBook.Exceptions.BadRequestException;
using KeynotFoundException = ApiBook.Exceptions.KeyNotFoundException;
using NotFoundException = ApiBook.Exceptions.NotFoundException;
using UnauthorizedException = ApiBook.Exceptions.UnauthorizedException;
using System.Net;
